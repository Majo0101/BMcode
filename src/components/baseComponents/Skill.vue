    ...
    <div class="row">
      <div class="col-md-4">
        <div class="rowRepair">
          <div class="col-1">
            <div class="bar">
              <div class="barLevel" style="height: 4em;"></div>
            </div>
          </div>
          <div class="col-10">
      ...
      <div class="col-md-4">
        <div class="rowRepair">
          <div class="col-1">
            <div class="bar">
              <div class="barLevel" style="height: 2.5em;"></div>
            </div>
          </div>
          <div class="col-10">
            <div class="textQuickWBolder">
      ...
      <div class="col-md-4">
        <div class="rowRepair">
          <div class="col-1">
            <div class="bar">
              <div class="barLevel" style="height: 3.5em;"></div>
            </div>
          </div>
          <div class="col-10">
            <div class="textQuickWBolder">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="rowRepair">
          <div class="col-1">
            <div class="bar">
              <div class="barLevel" style="height: 2em;"></div>
            </div>
          </div>
          <div class="col-10">
            <div class="textQuickWBolder">
...
<i18n>
{
  ...
  "en": {
    ...
    "skillBar4": "I am currently working on the Djnago framework together with Python.",
